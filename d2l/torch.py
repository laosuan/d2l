...
def read_data_nmt(position = '/Users/liuxuan/PycharmProjects/pythonProject/d2l-en/data/cmn-eng/cmn.txt'):
...
def tokenize_zh(text, num_examples=None):
    """Tokenize the English-French dataset.
    ...
    for i, line in enumerate(text.split('\n')):
        ...
        source.append(data['english'].split(' '))
        target.append(data['chinese'].split(' '))
    return source, target
...
def load_data_zh(batch_size, num_steps, num_examples=100000):
    """Return the iterator and the vocabularies of the translation dataset.

    Defined in :numref:`subsec_mt_data_loading`"""
    # text = preprocess_nmt(read_data_nmt('/Users/liuxuan/PycharmProjects/pythonProject/d2l-en/data/cmn-eng/test.txt'))
    text = preprocess_nmt(read_data_nmt('/Users/liuxuan/Documents/book/reading_ai/translation2019zh/translation2019zh_train.json'))
    source, target = tokenize_zh(text, num_examples)
    src_vocab = d2l.Vocab(source, min_freq=2,
                          reserved_tokens=['<pad>', '<bos>', '<eos>'])
    tgt_vocab = d2l.Vocab(target, min_freq=2,
                          reserved_tokens=['<pad>', '<bos>', '<eos>'])
